	...
	<div class="row">
		...
		<table style="width: 100%" class="col-md-12 col-sm-12 col-xs-12 table table-bordered">
			...
			<tr>
				...
				<td>
				<c:choose>
					<c:when test="${course.latitude eq '0' || course.longitude eq '0'}">
						없음
					</c:when>
					<c:otherwise>
						...
						<script>
							var courseLatitude = Number('${course.latitude}');
							var courseLongitude = Number('${course.longitude}');
						
							var mapContainer = document.getElementById('map'),
							    mapOption = { 
							        center: new kakao.maps.LatLng(courseLatitude, courseLongitude),
							        level: 3
							    };
							...
							var markerPosition  = new kakao.maps.LatLng(courseLatitude, courseLongitude); 
